    ...
    TweenMax.from("#g4378", 1.5, { rotation: 360, transformOrigin: "50% 90%", delay: 0.5, ease: Power1.easeInOut });
    ...
    TweenMax.from("#path5-circle3", 1.5, { drawSVG: "100% 700%", delay: 0.5 });
     // скалы и дома вверху
    tl.from("#g4445", 0.6, { opacity: 0, y: -250, ease: Back.easeInOut }, 0.1);
    tl.from("#g4452", 0.6, { opacity: 0, y: -250, ease: Back.easeInOut }, '-=0.6');

    tl.from("#g5908", 0.6, { opacity: 0, y: -250, ease: Back.easeInOut }, '-=0.7');
    tl.from("#g5725", 0.6, { opacity: 0, y: -250, ease: Back.easeOut }, '-=0.4');
    tl.from("#g5837", 0.6, { opacity: 0, y: -250, ease: Back.easeOut }, '-=0.4');
    tl.from("#path4449", 0.6, { opacity: 0, y: 300, ease: Power2.easeInOut }, '-=0.8');
    // облака
